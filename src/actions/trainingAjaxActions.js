...
export const GET_TRAININGS_DONE = "GET_TRAININGS_DONE";
export const getTrainingsDone = () => ({ type: GET_TRAININGS_DONE });
export const SET_TRAININGS_DONE = "SET_TRAININGS_DONE";
export const setTrainingsDone = (value) => ({
  type: SET_TRAININGS_DONE,
  value,
});
