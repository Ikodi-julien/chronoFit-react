...
export const getLocalTrainingsSuccess = (data) => ({
  type: GET_LOCAL_TRAININGS_SUCCESS,
  data,
});
...
export const GET_CURRENT_LOCAL_TRAINING_SUCCESS =
  "GET_CURRENT_LOCAL_TRAINING_SUCCESS";
...
export const deleteRoundFromLocalTraining = (index) => ({
  type: DELETE_ROUND_FROM_LOCAL_TRAINING,
  value: index,
});
...
export const putExoFormInTraining = (roundIndex, exoIndex) => ({
  type: PUT_EXOFORM_IN_LOCAL_TRAINING,
  roundIndex,
  exoIndex,
});

export const DELETE_EXO_FROM_ROUND = "DELETE_EXO_FROM_ROUND";
export const deleteExoFromRound = (roundIndex, exoIndex) => ({
  type: DELETE_EXO_FROM_ROUND,
  roundIndex,
  exoIndex,
});

export const MOVE_ROUND_IN_STATE = "MOVE_ROUND_IN_STATE";
export const moveRoundInState = (oldIndex, newIndex) => ({
  type: MOVE_ROUND_IN_STATE,
  oldIndex,
  newIndex,
});

export const MOVE_EXO_IN_STATE = "MOVE_EXO_IN_STATE";
export const moveExoInState = (obj) => ({
  type: MOVE_EXO_IN_STATE,
  value: obj,
});

export const SET_ROUND_ITERATION = "SET_ROUND_ITERATION";
export const setRoundIteration = (index, value) => ({
